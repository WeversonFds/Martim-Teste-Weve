   <?php get_header(); ?>
   <body>
      <section id="parte_1" style="padding-bottom:10vh;">
         <div class="container">
            <div class="row">
               <div class="col-md-6 col-12 order-2 order-md-1">
                  <h2 class="ata d-md-block d-none">Reembolsos corporativos de formas simples e rápida. </br><b> Como deve ser</b></h2>
                  <h2 class="ata d-md-none d-block"><b>Reembolsos corporativos de formas simples e rápida.</b> </br> Como deve ser</h2>
                  </br>
                  ...
                  <button type="button" class="btn btn-primary col-12 col-md-6 d-flex justify-content-center justify-content-md-start b1 upper"><b>Peça já a sua proposta</b></button>
                  <div class="d-12 col-12 d-flex justify-content-center justify-content-md-start">
                     <p class="cor_azul ml-1"> Responderemos <b>em até 24h</b></p>
                  </div>
               </div>
            ...
            <div class="row mt-2">
               <!--DIV ABRIR MODAL-->
               <div class="d-flex align-self-stretch col-md-6 col-12 bg_azul" style="min-height: 300px;" data-toggle="modal" data-target="#exampleModal">..</div>
               <!-- Modal -->
                     ...
                     <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <div class="embed-responsive embed-responsive-16by9">
                              <iframe class="embed-responsive-item" src="https://www.youtube.com/watch?v=4oeVCWTyUpY" allowfullscreen></iframe>
                           </div>
                        </div>
      ...
      <section id="parte_2" class="pt-md-5 mt-0">
         <div class="container-fluid p2">
            <div class="row">
               <div class="col-md-2"></div>
               <div class="col-md-3 col-12 mb-5">
                  <h2 class='h2p2'><b>Organizar</br>reembolsos</b> da sua empresa nunca foi tão rápido</h2>
                  <p style="color:#FFFFFF;">Utilizando BPP Corp, você tem controle total sobre o budget de sua equipe podendo realizar transferências instantâneas para os cartões corporativos dos colaboradores, acompanhar gastos, receber comprovantes e visualizar relatórios que organizam seu reembolso.</p>
      ...
      <section id="parte_3">
         <div class="container-fluid cp3">
            <div class="row d-flex justify-content-center">
               <h2 style="text-align: center;">A plataforma que ajuda a<b> reduzir os gastos</b> do dia a dia</h2>
               <div class="row justify-content-center">
                  <div class="col-md-7">
                  <p style="text-align: center;">Simplifique a gestão das despesas, evitando a perda de tempo com comprovantes e planilhas, reduzindo custos e aumentando os resultados da sua empresa.</p>
                     </div>
               </div>
            </div>
            ...
            <div class="carousel d-block d-md-none" data-flickity='{ "wrapAround": true }'>
      ...
      <section id="parte_4">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4 col-12 order-1 order-md-2 mt-md-5 mt-0 ml-md-5 ml-0 p-md-3">
                  <h2 style="color: #303D63">Conheça quem já conta com as <b>vantagens excluisivas</b> do BPP Corp</h2>
      ...
      <section id="parte_5">
         <div class="container">
         <div class="row d-flex justify-content-center">
            <center><h2 style="color:#303D63">Compare e <b>decida agora</b> mesmo</h2></center>
            <div class="col-md-8">
               <p style="text-align: center;">Substitua o uso do dinheiro em espécie pelo BPP Corp e ganhe segurança e praticidade, evitando roubos e perdas, tendo uma plataforma única para gerir suas despesas.</p>
            </div>
         </div>
         <div class="row mt-4">
            <div class="col-md-6 col-12">
               <div class="row">
                  ...
                  <div class="col-12">
                     ...
                     <span>Saque de dinheiro em papel para as despesa</span>
                     <span>Várias notas fiscais em papel</span>
                     <span>Diversas planilhas de gestão</span>
                     <span>Problemas de contabilização dos gastos</span>
                     <span>Não tem segurança</span>
                  </div>
               </div>
            </div>
            <hr class="d-block d-md-none linhac">
            </hr>    
            <div class="col-md-4 col-12">
               <hr class="d-none d-md-block linhap">
               </hr>
               <div class="row">
                  <div class="col-12 d-flex justify-content-center">
                  ...
                  <div class="col-12">
                     ...
                     <span class="bbc"><b>Faça pagamentos com o BPP Corp sem precisar tirar dinheiro</span>
                     <span class="bbc">Prestação de contas sem papel, via app</span>
                     <span class="bbc">Relatórios completos em um único lugar</span>
                     <span class="bbc">Controle dos gastos com cartões pré-pago</span>
                     <span class="bbc">Segurança total do seu dinheiro</span></b>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section id="parte_6">
          <div class="container-fluid p1">
              <div class="row">
                  <div class="col-12">
                      <h2 class="text-white" style="text-align: center">A sua gestão financeira nunca foi tão fácil</h2>
                  <p style="text-align: center; color:#FFFFFF;">Conte com as soluções do BPP Corp e facilite o controle dos gastos da sua empresa agora mesmo.</p>
                  <center><button type="button" class="btn btn-primary b3 upper"><b>Peça já a sua proposta</b></button></center>
                  <p style="text-align: center; color:#FFFFFF; margin-top:2vh;font-size:14px;padding-bottom:7vh">Proposta <b>grátis</b> e sem compromisso.</p>
                  </div>
              </div>
          </div>
      </section>
      ...
      <section id="parte_7">
          <div class="container">
              <div class="row">
                  <h2 class="ml-4 ml-md-1" style="color:#041F8F"><b>Últimos posts</b></h2>
              </div>
                  <div class='row'>
					<?php
